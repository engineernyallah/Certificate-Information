  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content" style="font-size: 14px; font-family: Times New Roman;color:black;">
      ...
      <div class="modal-body" >       	
      	<center> 
        		<form method="post" action="upload.php" enctype='multipart/form-data' style="width: 98%;">        		                                                     	      		
            <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;Certificate Type<br><label style="color: red;font-size:20px;"></label><input style="width:270px;" type="text" name="certificate_type" required></span></p>
        	    <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;&nbsp; &nbsp;Issued By<br><label style="color: red;font-size:20px;"></label><input style="width:270px;" type="text" name="issued_by" required></span></p>
        		<p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">Year Issued<br><label style="color: red;font-size:20px;"></label><input style="width:270px;" type="date" name="year_issued" required></span></p>
        	     <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Date Uploaded<br><label style="color: red;font-size:20px;"></label><input style="width:270px;" type="date" name="date_uploaded"r required></span></p>
        	     <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp;Attachment File<br><label style="color: red;font-size:20px;"></label><input style="width:270px;" type="file" accept=".pdf" name="attachment_file" required></span></p>
      ...
      <div class="modal-footer">
       <input type="submit" class="btn btn-success" value="Submit" id="addcertificate" name="addcertificate"> &nbsp;
        <button type="button" class="btn btn-success" data-dismiss="modal">Close</button>
      </div>
      </div>
       </form>
...
<?php   
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
               ...
               <li class="treeview">
              	  <a data-toggle='modal' href="#addcertificate" class="Open-Taxreceipted"><i class='fa fa-certificate'></i>Certificate</a>
               </li>
  ...
  <div id="addcertificate"  >
        ...
        <tbody>
        	 <?php   $sqlmember ="SELECT * FROM certificate_system ";
			       $retrieve = mysqli_query($db,$sqlmember);
				                    $count=0;
                     while($found = mysqli_fetch_array($retrieve))
	                 {
                      // $title=$found['Mtitle'];
                       ...
                       $attachment_file=$found['attachment_file'];
			                $count=$count+1;  
			      ...
			      echo"<tr>    <td>$id</td>                                       
			                 ...
			                 <td>
			                   <a data-toggle='modal' data-id='$id' data-ie='$certificate_type'   data-if='$issued_by' data-ig='$year_issued' data-ih='$date_uploaded' data-ij='$attachment_file'  class='open-Passwords btn  btn-info' title='edit user details' href='#Passwords'><span class='glyphicon glyphicon-edit' style='color:white;'></span></a>
